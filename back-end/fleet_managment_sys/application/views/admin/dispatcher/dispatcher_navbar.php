<nav class="navbar navbar-default" role="navigation" style="margin-bottom: 0px">
    ...
    <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#" id="dispatcher" onclick="getCROsView(this.id)">Dispatcher</a></li>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <form class="navbar-form navbar-left" role="search" id="getDispatcher">
            <div class="form-group">
                <input class="form-control" placeholder="Dispatcher ID" type="text" id="userIdSearch">
            </div>
<!--            <button type="submit" class="btn btn-default" onclick="getDriverView()">Submit</button>-->
                <button type="submit" id="dispatcher" class="btn btn-default" onclick="getCROView(this.id);return false;">Submit</button>
        </form>
