<form role="form" id="editDrivers">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="callingNumber" placeholder="Enter Calling Number" value="<?= $callingNumber;?>">
    </div>
    <div class="form-group">
...
<!--        <input type="text" class="form-control" id="cabId" placeholder="Enter Cab ID" value="<? //$cabId;?>">-->
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="startLocation" placeholder="Enter cab start location" value="<?= $startLocation;?>">
    </div>
    <div class="form-group">
